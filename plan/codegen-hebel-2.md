...
- P3 endet an der Kodierung von `takt prove` (Ströme, Handler, Sammlungen; m6.md 2.8). Für das UART-Programm bleibt die Intervallanalyse der einzige Beweiser; die 29 `Declared`-Stellen dort wären mit Kodierung der Ströme das nächste Ziel.
