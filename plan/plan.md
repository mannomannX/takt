...
| **M9 v2 (nach M8, vor M7)** | Verteilte Ausführung nach 12.9: Knotenticks, `hops`-Verlauf von Ψ, Abort über Knoten, Verbindungsverlust als Degradation/Fault, Aufzeichnung je Knoten, atomares Deployment; Bytecode-VM als Verbraucher der versionierten MIR | MIR-Platzhalter, Grammatik und Prüfung 58 existieren seit M0; keine Änderung an v1-Programmen nötig |
